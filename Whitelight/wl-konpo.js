const mainScript = () => {
    ...
    class HomeHeroAnimate {
        ...
        setup() {
            ...
            const desc = new SplitType('.home-hero-desc', { types: 'lines, words', lineClass: 'bp-line' });
            ...
            .from(desc.words, {autoAlpha: 0, yPercent: 80, duration: .6, stagger: .04}, "<=.1")
            if (!isSafariDesktop()) {
                this.tlTitle
                .from(titleBlur.words, {autoAlpha: 0, yPercent: 80, duration: .8, stagger: .05}, '<=0')
            }
            this.tlTitle
            .from(btn.words, {autoAlpha: 0, yPercent: 100, duration: .4, stagger: .06}, '<=.1')
