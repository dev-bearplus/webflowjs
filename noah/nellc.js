    ...
    const HomePage = {
        'home-hero-wrap': class extends TriggerSetup {
            ...
            animationScrub() {
                ...
                gsap.set('.home-hero-front-main-img', { scale: 1, y: 0, x: 0, width: originalWidth });
                ...
                this.tl
                    ...
                    .set('.home-hero-front-main-img', { scale: 1, y: -middleOffsetTop, width: originalWidth, transformOrigin: `${viewport.w <= 767 ? 47.75 : 50}% bottom`, duration: 0 }, "-=.1")
            ...
            interact() {
                ...
                if (viewport.w <= 767) {
                    ...
                    let swiper = new Swiper('.hub-hero-main-cms', {
                        ...
                        navigation: {
                            nextEl: '.hub-hero-main-ctrl-arr.next',
                            prevEl: '.hub-hero-main-ctrl-arr.prev',
                            disabledClass: 'disabled',
                        }
                    });
                }
