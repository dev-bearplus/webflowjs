...
const mainScript = () => {
    ...
    class Loader {
        ...
        init(data) {
            ...
            this.tlFirst
            .to('.loader-light', { opacity: .6, duration: .3 })
            .fromTo('.loader-text-inner', {yPercent: 0}, {yPercent: -1/3 * 100, duration: .6, ease: 'power1.inOut'}, "<=0")
        ...
        play(data) {
            ...
            // })
            // return;
            setTimeout(() => $('data-init-loader').removeAttr('data-init-loader'), 200);
    ...
    class Nav {
        ...
        initLinkActive() {
            this.el.querySelectorAll('a.w--current.active').forEach((el) => {
        ...
        animateToggle() {
            ...
            document.querySelectorAll('.nav-main-item').forEach((el, idx) => {
                ...
                tlShowItem
                    .fromTo(el.querySelector('.nav-main-item-thumb-icon'),
                        { yPercent: -100, scale: 1.5 },
                        { yPercent: 0, duration: .8, scale: 1, ease: 'power2.out', overwrite: true }, 0)
                    .fromTo(el.querySelector('.nav-main-item-thumb-inner'),
                        { yPercent: 100, autoAlpha: 0 },
                        { yPercent: 0, duration: .8, autoAlpha: 1, ease: 'power2.out', clearProps: 'all', overwrite: true }, 0.2)
            ...
            this.tlToggle
                .fromTo('.nav-bg', { autoAlpha: 0 }, {
                    autoAlpha: 1, duration: 1, ease: 'power2.in', overwrite: true,
                    onComplete: () => gsap.set(header.toggleEl, { clearProps: 'pointer-events' }),
                    onReverseComplete: () => gsap.set(header.toggleEl, { clearProps: 'pointer-events' })
                })
                .to(tlShowText, { duration: tlShowText.totalDuration(), progress: 1 }, ">=-.25")
        ...
        initHover() {
            ...
            document.querySelectorAll('.nav-main-item').forEach((el, idx) => {
                let icon = el.querySelector('.nav-main-item-thumb-icon');
        ...
        mouseEnter(el) {
            gsap.to(el.querySelector('.nav-main-item-thumb-inner'), { scale: 1.1, duration: .6, ease: 'power1.out' })
        }
        mouseLeave(el) {
            gsap.to(el.querySelector('.nav-main-item-thumb-inner'), { scale: 1, duration: .6, ease: 'power1.out' })
        }
        normalize(mousePos, maxDis) {
            return (mousePos / maxDis - 0.5) * 2;
        }
        mouseMove() {
            document.querySelectorAll('.nav-main-item').forEach((el, idx) => {
                let elRect = el.querySelector('.nav-main-item-thumb').getBoundingClientRect();
                let icon = el.querySelector('.nav-main-item-thumb-icon');

                const isHovered = el.querySelector('.nav-main-item-thumb').matches(':hover');
                this.mouse.xCurr = gsap.getProperty(icon, 'x');
                this.mouse.yCurr = gsap.getProperty(icon, 'y');
                this.mouse.xMove = isHovered ? this.normalize(mouse.mousePos.x - elRect.left, elRect.width) * 15 : 0;
                this.mouse.yMove = isHovered ? this.normalize(mouse.mousePos.y - elRect.top, elRect.height) * 15 : 0;

                gsap.set(icon, {
                    x: lerp(this.mouse.xCurr, this.mouse.xMove, .08),
                    y: lerp(this.mouse.yCurr, this.mouse.yMove,.08),
                })
            })
    ...
    class GlobalChange {
        ...
        updateLink(data) {
            ...
            document.querySelectorAll('.main-btn').forEach((el) => {
                gsap.set(el.querySelector('.main-btn-text-inner'), {
                    '--btn-width': el.getBoundingClientRect().height + 'px'
                })
            })
        }
        updateTheme(data) {
    ...
    class PageTrans {
        constructor() {
            ...
            this.homeCurrentScroll = window.innerWidth > 991 ? window.innerWidth + window.innerHeight * .09 : window.innerHeight + window.innerWidth * .09;
            this.updateSvg();
        ...
        Brand: class {
            ...
            setupEnter(data) {
                ...
                this.tlEnter
                    ...
                    .fromTo(this.el.querySelector('.home-brand-main-thumb-img .video-el'),
                        { yPercent: -100 },
            ...
            common(data) {
                ...
                this.tlReveal
                    ...
                    .fromTo(this.el.querySelectorAll('.home-brand-sub-link .main-btn'),
                        { scale: 1.2, autoAlpha: 0 },
                        { scale: 1, autoAlpha: 1, duration: 1, clearProps: 'all' }, "<=0.2")
            }
            desktop(data) {
                this.cardScrub(data);
            ...
            animateHorizontal(data) {
                ...
                this.tlParallax.push(parallaxTimeline({
                    ...
                    animEls: [
                        ...
                        { animEl: this.doubleTitle.getEls().main.lines[1], offset: { start: 20, end: -10 }},
                        { animEl: this.doubleTitle.getEls().main.lines[2], offset: { start: 20, end: -10 }},
                        { animEl: this.doubleTitle.getEls().clone.lines[0], offset: { start: 20, end: -10 }},
                        { animEl: this.doubleTitle.getEls().clone.lines[1], offset: { start: 20, end: -10 } },
                        { animEl: this.doubleTitle.getEls().clone.lines[2], offset: { start: 20, end: -10 }},
                    ]
                }))
                ...
                this.tlParallax.push(parallaxTimeline({
                    ...
                    animEls: [
                        { animEl: this.el.querySelector('.home-brand-sub-content.hidden-mb'), offset: { start: 10, end: -14 } },
            ...
            cardReveal(data) {
                ...
                gsap.set(el.querySelector('.home-brand-item-title'), { autoAlpha: 0 })
            ...
            cardScrub(data) {
                ...
                this.allCards.forEach((el, i) => {
                    ...
                    this.tlScrub
                        ...
                        .fromTo($(el).find(".home-brand-item-title"), { autoAlpha: 0 }, { autoAlpha: 1, duration: .5 }, '<=.2')
                })
        ...
        Voice: class {
            ...
            animateReveal(data) {
                ...
                this.tlReveal
                    ...
                    .fromTo(this.el.querySelector('.home-voice-sub-link .main-btn'),
                        { scale: 1.2, autoAlpha: 0 },
                        { scale: 1, autoAlpha: 1, duration: 1, clearProps: 'all' }, "<=.2")
        ...
        Logo: class {
            ...
            animateReveal(data) {
                ...
                this.tlReveal
                    .fromTo(sub.words,
                        { yPercent: 60, autoAlpha: 0 },
                        { yPercent: 0, autoAlpha: 1, duration: 1, stagger: 0.015, clearProps: 'all', onComplete: () => sub.revert() })
                    .fromTo(this.el.querySelector('.home-logo-sub-link .main-btn'),
                        { scale: 1.2, autoAlpha: 0 },
                        { scale: 1, autoAlpha: 1, duration: 1, clearProps: 'all' }, "<=.2")
            }
            animateHorizontal(data) {
                ...
                this.tlParallax
                    .push(gsap.timeline({
                            scrollTrigger: {
                                ...
                                horizontal: true, start: `left right`, end: `right left`, scrub: 1
                            },
                            defaults: { ease: 'none' }
                        })
                        .fromTo(this.el.querySelector('.home-logo-title'), { x: 300 }, { x: 0 })
                        .fromTo(this.el.querySelector('.home-logo-sub-wrap'), { x: 200 }, { x: -200 }, "<=0")
                        .fromTo(this.el.querySelectorAll('.home-logo-main-inner'), { scale: 1.2, transformOrigin: 'left' }, { scale: 1, ease: 'power1.out' }, "<=0")
                        .to(this.el.querySelectorAll('.home-logo-main-inner'), { scale: .8, transformOrigin: 'center', ease: 'power1.in' })
                    )
                ...
                this.tlParallax
                    .push(gsap.timeline({
                            scrollTrigger: {
                                trigger: this.el.querySelector('.home-logo-grid'),
                                horizontal: true, start: `left+=3% right`, end: `left+=3% left`, scrub: 1
                            },
                            defaults: { ease: 'none' }
                        })
                        // .fromTo(this.el.querySelectorAll('.home-logo-main-inner'), { scale: 2, transformOrigin: 'left' }, { scale: 1 }, "<=0")
                        .fromTo(this.el.querySelectorAll('.home-logo-main-grid'), { scale: 1.2, transformOrigin: '20%', autoAlpha: 0 }, { scale: 1, autoAlpha: 1 }, "<=0"))
            }
            animateVertical(data) {
                this.tlReveal = gsap.timeline({
                    scrollTrigger: {
            ...
            fetchSvg(data) {
                ...
                .then(svgContent => {
                    ...
                    this.el.querySelector('.home-logo-main-inner').appendChild(svgContainer);
                    this.el.querySelector('.home-logo-main-inner img.home-logo-main-img').remove();
        ...
        Typo: class {
            ...
            animateReveal(data) {
                ...
                this.tlReveal1
                    ...
                    .fromTo(this.el.querySelector('.home-typo-sub-desc-link .main-btn'),
                        { scale: 1.2, autoAlpha: 0 },
                        { scale: 1, autoAlpha: 1, duration: 1, stagger: 0.015, clearProps: 'all' }, "<=0.2")
        ...
        Photo: class {
            ...
            animateReveal(data) {
                ...
                this.tlReveal
                    ...
                    .fromTo(this.el.querySelector('.home-photo-sub-link .main-btn'),
                        { scale: 1.2, autoAlpha: 0 },
                        { scale: 1, autoAlpha: 1, duration: 1, clearProps: 'all' }, "<=.2")
            }
            desktop(data) {
            ...
            animateReveal(data) {
                ...
                this.tlReveal
                    .fromTo(sub.words,
                        { yPercent: 60, autoAlpha: 0 },
                        { yPercent: 0, autoAlpha: 1, duration: 1, stagger: 0.015, clearProps: 'all', onComplete: () => sub.revert() })
                    .fromTo(this.el.querySelector('.home-color-sub-link .main-btn'),
                        { scale: 1.2, autoAlpha: 0 },
                        { scale: 1, autoAlpha: 1, duration: 1, clearProps: 'all' }, "<=.2")
            }
            animateHorizontal(data) {
        ...
        ScrollBar: class {
            ...
            setupParams(data) {
                ...
                this.sections.forEach((el, i) => {
                    ...
                    el.setAttribute('id', name.toLowerCase().replace(/[^a-z0-9]+/g, '-'));
            ...
            setupRuler(data) {
                ...
                intervals.forEach((interval, index) => {
                    ...
                    let sectionName = this.sections[index].getAttribute('data-sc-name');
                    cloneItem.querySelector('.home-ruler-main-item-txt').innerText = sectionName;
                    cloneItem.querySelector('a').setAttribute('href', `#${this.sections[index].id}`);
            ...
            setTl(data) {
                    ...
                    for (let i = 0; i < breakpoints.length - 1; i++) {
                        ...
                        if (progress >= startPoint && progress < endPoint) {
                            ...
                            this.el.querySelectorAll('.home-ruler-main-item-txt').forEach((el, i) => {
                                el.parentElement.classList.toggle('active', i === this.currIndex);
                            })
                            break;
                        }
                    }
                ...
                let lastTwoRatios = this.ratios[this.ratios.length - 2] + this.ratios[this.ratios.length - 1];
                this.ratios.splice(this.ratios.length - 2, 2, lastTwoRatios);
                ...
                this.el.querySelectorAll('.home-ruler-main-item a').forEach((el, i) => {
                    let progress = breakpoints[i + 1] + (i === 0 ? 0.01 : .01);
                    let href = el.getAttribute('href');

                    el.addEventListener('click', (e) => this.scrollToID({ href, index: i, timeline: this.tlScrub, progress  }));
                })
            }
            showUp(data) {
                if ($(window).width() < 991) return;
            ...
            scrollToID({ href, index, timeline, progress }) {
                this.prevIndex = this.currIndex;
                let clickOnFirstEl = index === 0;
                let activeAtLastEl = this.prevIndex === this.el.querySelectorAll('.home-ruler-main-item a').length - 1
                let target = (clickOnFirstEl && clickOnFirstEl)
                        ? (timeline.scrollTrigger.end - timeline.scrollTrigger.start) * (1 + progress)
                        : href;
                ...
                smoothScroll.lenis.scrollTo(target, {
                    ...
                    onComplete: () => {
                        if (index !== this.currIndex) {
                            this.el.querySelectorAll('.home-ruler-main-item-txt').forEach((el, i) => {
                                el.parentElement.classList.toggle('active', i === index);
                            })
                        }
                    }
                })
    ...
    const DetailPage = {
        Hero: class {
            ...
            setup(data) {
                ...
                let borderRad = gsap.getProperty(this.el.querySelector('.detail-thumb .detail-main-img-inner'), 'border-radius');
                this.tl
                    .fromTo(title.chars,
                        { yPercent: 100, autoAlpha: 0 },
                    ...
                    .fromTo(this.el.querySelector('.detail-thumb .detail-main-img-inner'),
                        { clipPath: `inset(20% round ${borderRad}px)` },
                        { clipPath: `inset(0% round ${borderRad}px)`, duration: 2, ease: 'expo.out', clearProps: 'all'}, "<=.3")
            ...
            scrollDesktopHandler(data) {
                if (this.contentSections && this.contentSections.length != 0) {
                    this.contentSections.forEach((section, i) => {
                        ...
                        let paddingTop = section.querySelector('.detail-sec-space').getBoundingClientRect().height;

                        let calcPercent = (sectionRect.top - window.innerHeight) / (sectionRect.height) * -100;
                        let percent = gsap.utils.clamp(0, 100, calcPercent);

                        let topCalc = sectionRect.top - itemRect.top + paddingTop - itemRect.height * .5
                        ...
                        if (isInViewport(section, 'vertical')) {
                            this.subTocs[i].classList.add('active');
                        } else {
                            this.subTocs[i].classList.remove('active');
                        }
                    })
        ...
        Main: class {
            ...
            setup(data) {
                ...
                this.el.querySelectorAll('.detail-main-prompt-copy').forEach((el, idx) => {
                    el.addEventListener('click', this.copyTextToClipboard.bind(this));
                });
            }
            animate(data) {
                const animateType = {
                    fadeUp: (tl, el) => {
                        tl.fromTo(el.children,
                            { y: 100, opacity: 0 },
                            { y: 0, opacity: 1, duration: 1, stagger: 0.05, ease: 'power1.out', clearProps: 'transform, opacity' })
                    },
                    imageScale: (tl, el) => {
                        ...
                        const visibleImages = visibleChildren.flatMap(child => {
                            if (child.querySelector('img') === null) return [];
                        ...
                        tl.fromTo(visibleImages,
                            { scale: 1.3, opacity: 0 },
                            { scale: 1, opacity: 1, duration: 1, stagger: 0.1, ease: 'power2.out', clearProps: 'all' })
                    },
                    fadeListing: (tl, el) => {
                        tl.fromTo(el.querySelectorAll('.detail-main-listing-item'),
                            { y: 100, opacity: 0 },
                            { y: 0, opacity: 1, duration: 1, stagger: 0.1, ease: 'power1.out', clearProps: 'transform, opacity' })
                    }
                }
                ...
                data.querySelectorAll('.page-slot-wrap > div').forEach((item) => {
                    ...
                    if (item.classList.contains('detail-main-img-wrap') || item.classList.contains('detail-main-img')) {
                        animateType.imageScale(tl, item);
                    }
                    else if (item.classList.contains('detail-main-listing')) {
                        animateType.fadeListing(tl, item);
                    }
                    else {
                        animateType.fadeUp(tl, item);
                    }

                    if(item.classList.contains('detail-main-listing')) {
                        $(item).find('[data-accordion="true"] .accor-content').hide();
                        $(item).find('[data-accordion="true"] .accor-title').on('click', function(e) {
                            $(this).toggleClass('active');
                            $(this).closest('[data-accordion="true"]').find('.accor-content').slideToggle("slow");
                        })
                    }
                });
            }
            copyTextToClipboard(e) {
                e.preventDefault();
                let text = e.target.closest('.detail-main-prompt').querySelector('.code').innerText;
                let textArea = document.createElement('textarea');
                textArea.style.display = 'none';
                textArea.value = text;
                document.body.appendChild(textArea);
