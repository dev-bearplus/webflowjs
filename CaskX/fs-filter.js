function cmsfilter() {
    ...
    var ge = (t, e, r) => (e in t ? lt(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r));
    var Se = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports);
    var ye = (t, e, r, n) => {
        if ((e && typeof e == "object") || typeof e == "function") for (let o of de(e)) !Te.call(t, o) && o !== r && lt(t, o, { get: () => e[o], enumerable: !(n = fe(e, o)) || n.enumerable });
        return t;
    };
    var be = (t, e, r) => ((r = t != null ? pe(Ee(t)) : {}), ye(e || !t || !t.__esModule ? lt(r, "default", { value: t, enumerable: !0 }) : r, t));
    ...
    var P = (t, e) => (Array.isArray(e) || (e = [e]), e.map((n) => t.dispatchEvent(new Event(n, { bubbles: !0 }))).every((n) => n));
    ...
    var j = { preventLoad: { key: `${K}-preventload` }, debugMode: { key: `${K}-debug` }, src: { key: "src", values: { finsweet: "@finsweet/attributes" } }, dev: { key: `${K}-dev` } },
        [ft, pn] = Z(j);
    var kt = (t) => {
    ...
    var rt = ({ resultsElement: t }, { validItems: e }) => {
        ...
        ot = ({ filtersData: t }) => {
            for (let { elements: e } of t) for (let { resultsElement: r, resultsCount: n } of e) r && (r.textContent = `${n}`);
        },
    ...
    var Er = "fs-cms-element",
        Tr = { wrapper: "wrapper", list: "list", item: "item", paginationWrapper: "pagination-wrapper", paginationNext: "pagination-next", paginationPrevious: "pagination-previous", pageCount: "page-count", emptyState: "empty" },
        Jt = (t) => {
            let e = `.${Mt[t]}`,
                r = `[${Er}="${Tr[t]}"]`;
            return `:is(${e}, ${r})`;
    ...
    var {
        ...
        te = (t) => {
            let e = t.querySelector("form"),
                ...
                n = [...h("reset", { scope: t, operator: "prefixed", all: !0 }), ...h("resetFallback", { scope: t, operator: "prefixed", all: !0 })],
                o = new Map();
            for (let s of n) {
        ...
        kr = (t, e, r, n, o, s, i) => {
            ...
            return [
                { match: E, filterKeys: r, originalFilterKeys: e, highlight: A, tagFormat: f, tagCategory: T, highlightCSSClass: C, mode: S, values: new Set() },
                ...
                let A = a.filter((C) => {
                    ...
                    return g.some((S) => {
                        ...
                        if (T === "date" && !m) {
                            ...
                            b = x === z;
                        } else l.some(({ type: x }) => !["checkbox", "radio", "select-one"].includes(x)) || e.length > 1 ? (b = S.toLowerCase().includes(C.toLowerCase())) : (b = C.toLowerCase() === S.toLowerCase());
    ...
    var it = class {
        ...
        handleClick(e) {
            ...
            let { hasRemoveTrigger: n, tagsData: o, listInstance: s } = this,
                i = r.closest(U("element", "tagTemplate", { instanceIndex: s.getInstanceIndex(F.element.key) }));
            if (!i) return;
    ...
    var {
        ...
        ce = (t, e) => {
            ...
            let l = h("resultsCount", { instanceIndex: r }),
                ...
                f = new st(o, t, { resultsElement: l, showQueryParams: a, allowSubmit: m, highlightAll: c, highlightCSSClass: u, activeCSSClass: p, debouncing: E });
