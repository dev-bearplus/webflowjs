    ...
    return (function (e) {
        ...
        function (e, t) {
            ...
            var n = function (e, t, n) {
                    ...
                    if (t > e.position) {
                        if (e.node.classList.contains('aos-animated')) return;
                        e.node.classList.add("aos-animate");
                        let delayDur = Number(e.node.getAttribute('data-aos-delay')?e.node.getAttribute('data-aos-delay'):0) + Number(document.querySelector("body").getAttribute('data-aos-duration'));
                        e.node.classList.add('aos-animated')
                        setTimeout(() => {
                            e.node.removeAttribute('data-aos')
                            e.node.hasAttribute('data-aos-delay') && e.node.removeAttribute('data-aos-delay')
                            setTimeout(() => e.node.classList.add('anim-inside'), 200);
                        }, delayDur);
                    } else {
                        if (typeof o!== "undefined" && ("false" === o || (!n && "true"!== o))) {
